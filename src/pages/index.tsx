  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR operations with HR Management Application, your ultimate tool for efficient and effective human resource processes."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR operations with HR Management Application, your ultimate tool for efficient and effective human resource processes.`}
            </Text>
            <Box
