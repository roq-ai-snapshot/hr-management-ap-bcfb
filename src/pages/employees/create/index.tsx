...
function EmployeeCreatePage() {
  ...
  const formik = useFormik<EmployeeInterface>({
    initialValues: {
      position: '',
      salary: 0,
      hired_at: new Date(new Date().toDateString()),
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="hired_at" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Hired At
            </FormLabel>
            <DatePicker
              selected={formik.values?.hired_at ? new Date(formik.values?.hired_at) : null}
              onChange={(value: Date) => formik.setFieldValue('hired_at', value)}
            />
          </FormControl>
